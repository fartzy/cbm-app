...
public class EDABusinessTierDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		EDAMessageListSerializer cbmMessageListSerializer = new EDAMessageListSerializer();
		EDAMessageListDeserializer cbmMessageListDeserializer = new EDAMessageListDeserializer();

		Serde<EDAMessageList> cbmMessageListSerde = Serdes.serdeFrom(edaMessageListSerializer,edaMessageListDeserializer);
